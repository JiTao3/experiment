...
train_rows = np.load("/home/jitao/experiment/data/range_feature_data/cover_5000_attr_seven_rows.npy").astype(
    np.float
)

train_range = np.load("/home/jitao/experiment/data/range_feature_data/cover_5000_attr_seven_range_features.npy").astype(
    np.float
)
...
with open("data/range_row_quicksel/cover_7d_range_le1.txt", "w") as f:
    f.writelines(
        [
            "{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.8f}\n".format(
